...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $stmt = $conn->prepare("INSERT INTO investor (name, amount) VALUES (?, ?)");
    ...
    <div class="col-12 col-md-8 col-lg-6">
        <div class="card">
            <div class="card-header bg-primary text-white">
                <h4 class="mb-0"><i class="fas fa-user-plus me-2"></i>Add Investor</h4>
            </div>
            <div class="card-body p-4">
                ...
                <?php if (isset($_GET['success'])): ?>
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        <i class="fas fa-check-circle me-2"></i>Investor added successfully!
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
                <?php endif; ?>
                ...
                <form method="POST">
                    <div class="mb-3">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" class="form-control" id="name" name="name" placeholder="Enter investor name" required>
                        </div>
                    </div>
                    <div class="mb-4">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" id="amount" name="amount" placeholder="Enter investment amount" required>
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save me-1"></i> Add Investor
                        </button>
                    </div>
                </form>
            </div>
